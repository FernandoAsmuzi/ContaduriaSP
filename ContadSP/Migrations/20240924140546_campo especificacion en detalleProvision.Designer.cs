...
namespace ContadSP.Migrations
{
    ...
    [Migration("20240924140546_campo especificacion en detalleProvision")]
    partial class campoespecificacionendetalleProvision
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContadSP.Models.Articulo", b =>
                {
                    ...
                    b.Property<int?>("estado_articulo_id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ContadSP.Models.DetalleProvision", b =>
                {
                    ...
                    b.Property<bool?>("cancela_provision")
                    ...
                    b.Property<string>("observa_cancelacion")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("ContadSP.Models.EstadoArticulo", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ContadSP.Models.Provision", b =>
                {
                    ...
                    b.Property<bool?>("CancelarProvision")
                        .HasColumnType("tinyint(1)");

                    b.Property<string>("ObservacionCancela")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("ContadSP.Models.Articulo", b =>
                {
                    ...
                    b.HasOne("ContadSP.Models.EstadoArticulo", "EstadoArticulo")
                        .WithMany("Articulos")
                        .HasForeignKey("estado_articulo_id");
